...
var ButtonStyled = styled__default.div(_templateObject, function (props) {
  return props.theme.button.borderColor;
}, styledSystem.width);

var Text = styled__default.label(_templateObject2);
...
Button$1.propTypes = {
  children: propTypes$1.oneOf([propTypes$1.node, propTypes$1.string])
};

Button$1.defaultProps = _extends({
  children: 'Button Text'
}, styledSystem.propTypes.width);
...
var flatten = function flatten(name, colors) {
  return colors.reduce(function (a, b, i) {
    var color = defineProperty({}, name + i, {
      enumerable: true,
      get: function get$$1() {
...
var _templateObject$1 = taggedTemplateLiteral(['body {\n  margin: 0;\n}'], ['body {\n  margin: 0;\n}']);
var _templateObject2$1 = taggedTemplateLiteral(['\n  font-family: ', ';\n  line-height: 1.4;\n  * {\n    box-sizing: border-box;\n  }\n'], ['\n  font-family: ', ';\n  line-height: 1.4;\n  * {\n    box-sizing: border-box;\n  }\n']);

styled.injectGlobal(_templateObject$1);

var Base = styled__default.div(_templateObject2$1, function (props) {
